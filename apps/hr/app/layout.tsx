...
export const metadata: Metadata = { title: "HR Documents · MapleOne" };
  ...
  return (
    <html lang="en" className={`${outfit.variable} ${instrument.variable} h-full`} suppressHydrationWarning>
      <body className="min-h-full">
        {toolOn ? (<SuiteShell user={user} brand={brand} current="hr">{children}</SuiteShell>) : (<ToolDisabled label="Hr" />)}
