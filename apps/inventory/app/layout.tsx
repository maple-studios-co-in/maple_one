...
export const metadata: Metadata = { title: "Inventory · MapleTools" };
  ...
  return (
    <html lang="en" className={`${outfit.variable} ${instrument.variable} h-full`} suppressHydrationWarning>
      <body className="min-h-full">
        {toolOn ? (<SuiteShell user={user} current="inventory">{children}</SuiteShell>) : (<ToolDisabled label="Inventory" />)}
