...
export const metadata: Metadata = { title: "MapleTools Docs" };
      ...
      <body className="min-h-full">
        <div className="flex min-h-screen">
          <aside className="hidden w-64 shrink-0 flex-col border-r border-border bg-sidebar p-5 md:flex">
            <Link href="/"><div className="font-serif text-2xl text-primary">Maple<span className="text-foreground">Tools</span></div><div className="text-[11px] text-muted-foreground">Team documentation</div></Link>
