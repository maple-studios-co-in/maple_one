...
export const metadata: Metadata = { title: "Photoshoot · MapleOne" };
  ...
  return (
    <html lang="en" className={`${outfit.variable} ${instrument.variable} h-full`} suppressHydrationWarning>
      <body className="min-h-full">
        {toolOn ? (<SuiteShell user={user} brand={brand} current="photoshoot">{children}</SuiteShell>) : (<ToolDisabled label="Photoshoot" />)}
