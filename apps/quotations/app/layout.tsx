...
export const metadata: Metadata = { title: "Quotations · MapleTools" };
  ...
  return (
    <html lang="en" className={`${outfit.variable} ${instrument.variable} h-full`} suppressHydrationWarning>
      <body className="min-h-full">
        {toolOn ? (<SuiteShell user={user} current="quotations">{children}</SuiteShell>) : (<ToolDisabled label="Quotations" />)}
